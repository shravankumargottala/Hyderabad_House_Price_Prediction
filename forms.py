...
class HousePrice(FlaskForm):
    ...
    No_of_Bathrooms = IntegerField('No of Bathrooms:', validators=[Required()])
    No_of_Balconies = IntegerField('No of Balconies:', validators=[Required()])
    No_of_Poojarooms = IntegerField('No of Poojarooms:', validators=[Required()])
    Supr_Area = IntegerField('Super Area:', validators=[Required()])
    Carp_Area = IntegerField('Carpet Area:', validators=[Required()])
