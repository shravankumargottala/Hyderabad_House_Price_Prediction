...
class HousePrice(FlaskForm):
    ...
    No_of_Balconies = IntegerField('No of Balconies:', validators=[InputRequired()])
    No_of_Poojarooms = IntegerField('No of Poojarooms:', validators=[InputRequired()])
    Supr_Area = IntegerField('Super Area:', validators=[InputRequired()])
    Carp_Area = IntegerField('Carpet Area:', validators=[InputRequired()])
...
class FlatPrice(FlaskForm):
    ...
    Supr_Area = IntegerField('Super Area:', validators=[InputRequired()])
    Carp_Area = IntegerField('Carpet Area:', validators=[InputRequired()])
    Floor_No = IntegerField('Floor No:', validators=[InputRequired()])
    Total_Floors = IntegerField('Total Floors:', validators=[InputRequired()])
    Furn_status = SelectField('Furnishing Status:', choices=tuple(furn_main_list))
    Fac_status = SelectField('Facing:', choices=tuple(fac_main_list))
    Addrss = SelectField('Address:', choices=tuple(addr_main_list))
    submit = SubmitField('Predict', render_kw={"onclick": "checkform()"})
