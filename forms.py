...
class HousePrice(FlaskForm):
    ...
    No_of_Bedrooms = IntegerField('No of Bedrooms:',validators=[InputRequired()],render_kw={"placeholder": "i.e 1,2,3"})
    No_of_Bathrooms = IntegerField('No of Bathrooms:', validators=[InputRequired()],render_kw={"placeholder": "i.e 0,1,2"})
    No_of_Balconies = IntegerField('No of Balconies:', validators=[InputRequired()],render_kw={"placeholder": "i.e 0,1,2"})
    No_of_Poojarooms = IntegerField('No of Poojarooms:', validators=[InputRequired()],render_kw={"placeholder": "i.e 0,1,2"})
...
class FlatPrice(FlaskForm):
    ...
    Supr_Area = IntegerField('Super Area:', validators=[InputRequired()],render_kw={"placeholder": "i.e 800,900 ( in sqft )"})
    Carp_Area = IntegerField('Carpet Area:', validators=[InputRequired()],render_kw={"placeholder": "i.e 800,900 ( in sqft )"})
    Floor_No = IntegerField('Floor No:', validators=[InputRequired()],render_kw={"placeholder": "i.e 1,2,3"})
    Total_Floors = IntegerField('Total Floors:', validators=[InputRequired()],render_kw={"placeholder": "i.e 1,2,3"})
    Furn_status = SelectField('Furnishing Status:', choices=tuple(furn_main_list))
    Fac_status = SelectField('Facing:', choices=tuple(fac_main_list))
    Addrss = SelectField('Address:', choices=tuple(addr_main_list))
    submit = SubmitField('Predict', render_kw={"onclick": "checkform()"})
